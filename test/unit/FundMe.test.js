...
!developmentChains.includes(network.name)
    ...
    : describe("FundMe", () => {
          ...
          describe("fund", () => {
              ...
              it("Update the amountfunded data structure", async function () {
              ...
              it("Add funder to the getFunders array", async function () {
                  await fundMe.fund({ value: sendValue })
          ...
          describe("withdraw", function () {
              ...
              it("Allow us to withdraw multiple getFunders", async function () {
                  // Arrange
                  const accounts = await ethers.getSigners()
                  for (let i = 1; i < 6; i++) {
                      const connectedAccounts = await fundMe.connect(
                          accounts[i]
                      )
                      await connectedAccounts.fund({ value: sendValue })
                  }
              ...
              it("chaperWithdraw ETH from a single founder", async function () {
                  // Arrange
                  const startingFundMeBalance =
                      await fundMe.provider.getBalance(fundMe.address)
                  const startingDeployerBalance =
